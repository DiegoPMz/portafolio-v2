...
const buttonVariants = cva(
  "cursor-pointer group relative border rounded-2xl transition-all duration-500 overflow-hidden backdrop-blur-sm flex-1",
  {
    variants: {
      variant: {
        default:
          "bg-zinc-800/30 hover:bg-zinc-800/50 border-zinc-700/40 hover:border-zinc-600/60",
        blue: "g-zinc-800/50 hover:bg-zinc-800/70 border-zinc-700/50 hover:border-zinc-600/50 ",
      },
      size: {
        default: "px-8 py-4 md:px-12 md:py-6 ",
        sm: "px-4 py-2 md:px-8 md:py-4",
      },
    },
    defaultVariants: {
      variant: "default",
